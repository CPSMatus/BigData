...
function assignColorToTableColumns(tableId, attributeIndexAr){
    for(var i = 0; i < attributeIndexAr.length; ++i){
        console.log(attributeIndexAr[i]);
        assignColorToTableColumn(tableId, attributeIndexAr[i]);
    }
}
...
function assignColorToTableColumn(tableId, attributeIndex){
    ...
    for(var i = 0 ; i < trNodes.length; ++i){
        ...
        cellNode[attributeIndex].style.cssText += "background-color: hsl(" + (coef*360/3.) + ", 50%, 50%);";
    }
}
